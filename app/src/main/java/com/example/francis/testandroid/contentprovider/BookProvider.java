...
public class BookProvider extends ContentProvider{
    ...
    public static final String AUTHORITY = "com.example.francis.testandroid.book.provider";
    ...
    public boolean onCreate() {
        //只有onCreate方法在主线程, 其余方法均为外界回调并运行在Binder线程池中
        Log.d(TAG, "onCreate: " + Thread.currentThread().getName());
        mContext = getContext();
        //初始化数据库, 实际操作中不建议在主线程中做耗时操作
        initProviderData();
        return false;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //insert, delete, update 会改变数据需要通知外界数据改变了
